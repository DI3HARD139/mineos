...
function notepad(player, perform)
	...
	"image_button[7.4,1.53;.32,.295;minimize_w.png;minimize_np;;true;false;]" ..
	"image_button[7.7,1.53;.38,.297;maximize_w.png;maximize_np;;true;false;]" ..
	"image_button[8,1.53;.35,.295;close_w.png;close_notepad;;true;false;]" ..
...
minetest.register_on_player_receive_fields(function(player, formname, fields)
	if formname == "mineos:desktop" then
		...
		if fields.maximize_np then
			...
			"image_button[9.9,0;.32,.295;minimize_w.png;minimize_np;;true;false;]" ..
			"image_button[10.2,0;.38,.297;window_w.png;window_np;;true;false;]" ..
			"image_button[10.5,0;.35,.295;close_w.png;close_notepad;;true;false;]" ..
